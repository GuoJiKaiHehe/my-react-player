...
import PubSub from 'pubsub-js'  //事件库；
...
class Player extends Component{
  ...
  componentDidMount(){
      // console.log($.jPlayer.event.timeupdate)
      $("#player").bind($.jPlayer.event.timeupdate,(e)=>{
        this.duration = e.jPlayer.status.duration;

        this.setState({
          progress:  e.jPlayer.status.currentPercentAbsolute, //当前百分之几；
        ...
        <div className="player-page">
          ...
          <div className="mt20 row">
            <div className="controll-wrapper">
              ...
              <h3  className="music-article mt10">{artist}</h3>
